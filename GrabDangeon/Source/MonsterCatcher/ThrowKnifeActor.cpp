...
AThrowKnifeActor::AThrowKnifeActor()
{
	...
	// Hit ��g������ Pawn �� Block �ɂ���iOverlap �ł� Hit �͏o�Ȃ��j
	...
	KunaiCollision->SetNotifyRigidBodyCollision(true); // OnHit �ɕK�{
	KunaiCollision->SetGenerateOverlapEvents(false);   // Overlap �͎g��Ȃ�
